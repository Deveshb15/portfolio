        ...
        <div className="flex justify-center my-8 mt-16">
            <section className="interests">
                ...
                <div className="relative">
                    <h1 className="text-8xl absolute -top-20 left-2.5 right-0 bottom-0 font-extrabold uppercase -z-1 text-gray-200 mt-4 invisible sm:visible">Tech Stack</h1>
                    <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-x-2 py-5">
                    <div className="mt-2 pt-4">
                        <div className="flex items-center justify-center sm:justify-start p-5 hover:bg-gray-200">
                    ...
                    <div className="mt-2 pt-0 lg:pt-4">
                        <div className="flex items-center justify-center sm:justify-start p-5 hover:bg-gray-200">
